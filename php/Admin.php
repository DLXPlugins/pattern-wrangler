		...
		if ( $enable_enhanced_view ) {
			...
			wp_localize_script(
				...
				array(
					...
					'networkPatternsConfiguration'  => Options::get_network_options()['patternConfiguration'] ?? 'local_only',
					'effectivePatternConfiguration' => Functions::get_network_pattern_configuration( get_current_blog_id() ),
				)
			);
