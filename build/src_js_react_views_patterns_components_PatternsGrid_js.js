...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../store */ "./src/js/react/views/patterns/store/index.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var PatternsGrid = function PatternsGrid(props) {
  var _useSelect = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.useSelect)(function (select) {
      return {
        data: select(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).getData(),
        loading: select(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).getLoading(),
        error: select(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).getError()
      };
    }),
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).fetchData();
  }, []);
  ...
  if (error) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: function onClick() {
        return (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).fetchData();
      }
...
var Interface = function Interface(props) {
  ...
  var _useSelect2 = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.useSelect)(function (select) {
      return {
        patterns: select(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).getPatterns()
      };
    }),
  ...
  var _useSelect3 = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.useSelect)(function (select) {
      return {
        categories: select(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).getCategories()
      };
    }),
  ...
  var _useState31 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(getDefaultView()),
    _useState32 = _slicedToArray(_useState31, 2),
    view = _useState32[0],
    setView = _useState32[1];
  ...
  (view === null || view === void 0 || (_view$filters4 = view.filters) === null || _view$filters4 === void 0 || (_view$filters4 = _view$filters4.find(function (filter) {
  ...
  }, /*#__PURE__*/React.createElement(_wordpress_dataviews__WEBPACK_IMPORTED_MODULE_15__["default"].Filters, null)), /*#__PURE__*/React.createElement(_wordpress_dataviews__WEBPACK_IMPORTED_MODULE_15__["default"].Layout, null), /*#__PURE__*/React.createElement(_wordpress_dataviews__WEBPACK_IMPORTED_MODULE_15__["default"].BulkActionToolbar, null), /*#__PURE__*/React.createElement(_wordpress_dataviews__WEBPACK_IMPORTED_MODULE_15__["default"].Pagination, null)), snackbar.isVisible && /*#__PURE__*/React.createElement(_Snackbar__WEBPACK_IMPORTED_MODULE_11__["default"], {
    ...
    onEdit: function onEdit(editResponse) {
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).upsertCategory(editResponse.categories);
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.dispatch)(_store__WEBPACK_IMPORTED_MODULE_14__["default"]).setPattern(editResponse.patternId, editResponse.patternTitle, editResponse.categorySlugs, editResponse.categorySlugs);
    ...
    onPause: function onPause(pauseResponse) {
...
//# sourceMappingURL=src_js_react_views_patterns_components_PatternsGrid_js.js.map?ver=628dcd251b7ee2c3d737